...
const USER_DIR = path.join(__dirname, "../../Frontend/pages/user");
...
const buildSidebar = (activePage) => `  <aside class="sidebar">
    <a href="dashboard.html" class="sidebar-brand">
      ...
      <div class="sidebar-brand-text"><strong>بوابة الطالب</strong><span>جامعة التميز</span></div>
    </a>
    <nav class="sidebar-nav">
      ...
      <a href="courses.html"     class="nav-item${activePage==="courses"?" active":""}"><svg viewBox="0 0 24 24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>موادي الدراسية</a>
      <a href="schedule.html"    class="nav-item${activePage==="schedule"?" active":""}"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>الجدول الدراسي</a>
      ...
      <a href="grades.html"      class="nav-item${activePage==="grades"?" active":""}"><svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>النتائج والدرجات</a>
      <a href="assignments.html" class="nav-item${activePage==="assignments"?" active":""}"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>الواجبات</a>
      <a href="leaderboard.html" class="nav-item${activePage==="leaderboard"?" active":""}"><svg viewBox="0 0 24 24"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16"/></svg>لوحة الشرف</a>
      ...
      <a href="financials.html"  class="nav-item${activePage==="financials"?" active":""}"><svg viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="16" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>الماليات</a>
      ...
      <a href="support.html"     class="nav-item${activePage==="support"?" active":""}"><svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>الدعم الفني</a>
    </nav>
...
console.log(`Updated ${updated} student pages.`);
